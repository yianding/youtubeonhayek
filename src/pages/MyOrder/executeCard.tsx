...
import { useWrapExecuteCallback, useWrapSurrenderCallback } from '../../hooks/useWrapCallback1'
import { ethers } from 'ethers'
import { useGetDisputeResultCallBack } from '../../hooks/useApproveCallback'
...
export default function ExecuteCard(props: any, border: any) {
    ...
    let disputeResult = useGetDisputeResultCallBack(props.pair.arbitration.toString(), props.pair.id)
